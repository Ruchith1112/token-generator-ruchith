...
//     // Ensure all inputs are valid before generating tokens
...
//     // Update errors if any required fields are missing
...
//     setBlueTokens(generate(Number(inputs.numberOfBlue), inputs.bluePrefix));
//     setRedTokens(generate(Number(inputs.numberOfRed), inputs.redPrefix));
//   };
...
//       inputs, handleChange, generateTokens, clearTokens, blueTokens, redTokens, errors
//     }}>
//       {children}
